                ...
                <div class="flex sm:flex-row flex-col w-full xl:mt-12 mb-12 xl:px-0 px-4">
                    <div class="sm:w-1/3 mb-8 sm:mb-0 xl:pr-0 pr-2">
                        <div class="flex flex-wrap mb-4">
                            ...
                            <div class="w-5/6"><h4 class="text-black items-center xl:text-2xl">Daerah</h4></div>
                        </div>
                    ...
                    <div class="sm:w-1/3 mb-8 sm:mb-0 xl:pr-0 pr-2">
                        <div class="flex flex-wrap mb-4">
                            ...
                            <div class="w-4/5"><h4 class="text-black items-center xl:text-2xl">Istimewa</h4></div>
                        </div>
                        <p><b class="font-normal text-blue-600">No more Mulitple Platforms.</b> Now it had see nunable uneasy. Drawings can followed by improved out sociable not. Earnestly so do instantly pretended.</p>
                    </div>
                    <div class="sm:w-1/3 mb-8 sm:mb-0 xl:pr-0 pr-2">
                        <div class="flex flex-wrap mb-4">
                            ...
                            <div class="w-4/5"><h4 class="text-black items-center xl:text-2xl">Yogyakarta</h4></div>
                        </div>
                        <p><b class="font-normal text-blue-600">No more Mulitple Platforms.</b> Now it had see nunable uneasy. Drawings can followed by improved out sociable not. Earnestly so do instantly pretended.</p>
                    </div>
                </div>
